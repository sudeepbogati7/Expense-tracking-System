...
export default function AboutMe() {
    return (
        <>
            <div className="container flex items-center w-full mx-auto py-4 px-2 my-4 flex-col mx-auto border-b border-gray-400 ">
                ...
                <Link href={'/'} className='w-fit  mx-auto border border-gray-300 px-4 py-2 mt-6 rounded-lg bg-gray-300 active:border-2 active:bg-orange-200 active:border-orange-700 transition-all duration-300 dark:bg-gray-800 dark:border-none dark:active:bg-orange-600'>Home</Link>
            </div>
            <div className='flex flex-col px-4'>
                ...
                <div className='flex items-center justify-around rounded-xl bg-gray-50 dark:bg-gray-500'>
                    <span className='hover:bg-blue-500 rounded-full overflow-hidden'>
                        <svg height="30pt" viewBox=".5 -.2 1023 1024.1" width="30pt" xmlns="http://www.w3.org/2000/svg"><path d="m478.5.6c-2.2.2-9.2.9-15.5 1.4-145.3 13.1-281.4 91.5-367.6 212-48 67-78.7 143-90.3 223.5-4.1 28.1-4.6 36.4-4.6 74.5s.5 46.4 4.6 74.5c27.8 192.1 164.5 353.5 349.9 413.3 33.2 10.7 68.2 18 108 22.4 15.5 1.7 82.5 1.7 98 0 68.7-7.6 126.9-24.6 184.3-53.9 8.8-4.5 10.5-5.7 9.3-6.7-.8-.6-38.3-50.9-83.3-111.7l-81.8-110.5-102.5-151.7c-56.4-83.4-102.8-151.6-103.2-151.6-.4-.1-.8 67.3-1 149.6-.3 144.1-.4 149.9-2.2 153.3-2.6 4.9-4.6 6.9-8.8 9.1-3.2 1.6-6 1.9-21.1 1.9h-17.3l-4.6-2.9c-3-1.9-5.2-4.4-6.7-7.3l-2.1-4.5.2-200.5.3-200.6 3.1-3.9c1.6-2.1 5-4.8 7.4-6.1 4.1-2 5.7-2.2 23-2.2 20.4 0 23.8.8 29.1 6.6 1.5 1.6 57 85.2 123.4 185.9s157.2 238.2 201.8 305.7l81 122.7 4.1-2.7c36.3-23.6 74.7-57.2 105.1-92.2 64.7-74.3 106.4-164.9 120.4-261.5 4.1-28.1 4.6-36.4 4.6-74.5s-.5-46.4-4.6-74.5c-27.8-192.1-164.5-353.5-349.9-413.3-32.7-10.6-67.5-17.9-106.5-22.3-9.6-1-75.7-2.1-84-1.3zm209.4 309.4c4.8 2.4 8.7 7 10.1 11.8.8 2.6 1 58.2.8 183.5l-.3 179.8-31.7-48.6-31.8-48.6v-130.7c0-84.5.4-132 1-134.3 1.6-5.6 5.1-10 9.9-12.6 4.1-2.1 5.6-2.3 21.3-2.3 14.8 0 17.4.2 20.7 2z" /><path d="m784.3 945.1c-3.5 2.2-4.6 3.7-1.5 2 2.2-1.3 5.8-4 5.2-4.1-.3 0-2 1-3.7 2.1zm-6.9 4.5c-1.8 1.4-1.8 1.5.4.4 1.2-.6 2.2-1.3 2.2-1.5 0-.8-.5-.6-2.6 1.1zm-5 3c-1.8 1.4-1.8 1.5.4.4 1.2-.6 2.2-1.3 2.2-1.5 0-.8-.5-.6-2.6 1.1zm-5 3c-1.8 1.4-1.8 1.5.4.4 1.2-.6 2.2-1.3 2.2-1.5 0-.8-.5-.6-2.6 1.1zm-7.6 4c-3.8 2-3.6 2.8.2.9 1.7-.9 3-1.8 3-2 0-.7-.1-.6-3.2 1.1z" /></svg>
                    </span>
                    <span className=''>
                        <Image src={'/ts-logo-256.png'} width={40} height={40} alt='ts-logo'></Image>
                    </span>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="40" height="40"><path d="M32 24.795c-1.164.296-1.884.013-2.53-.957l-4.594-6.356-.664-.88-5.365 7.257c-.613.873-1.256 1.253-2.4.944l6.87-9.222-6.396-8.33c1.1-.214 1.86-.105 2.535.88l4.765 6.435 4.8-6.4c.615-.873 1.276-1.205 2.38-.883l-2.48 3.288-3.36 4.375c-.4.5-.345.842.023 1.325L32 24.795zM.008 15.427l.562-2.764C2.1 7.193 8.37 4.92 12.694 8.3c2.527 1.988 3.155 4.8 3.03 7.95H1.48c-.214 5.67 3.867 9.092 9.07 7.346 1.825-.613 2.9-2.042 3.438-3.83.273-.896.725-1.036 1.567-.78-.43 2.236-1.4 4.104-3.45 5.273-3.063 1.75-7.435 1.184-9.735-1.248C1 21.6.434 19.812.18 17.9c-.04-.316-.12-.617-.18-.92q.008-.776.008-1.552zm1.498-.38h12.872c-.084-4.1-2.637-7.012-6.126-7.037-3.83-.03-6.58 2.813-6.746 7.037z" /></svg>
                    </span>
                    <span>
            ...
            <footer className=' border-t border-gray-400 bg-gradient-to-t from-[#BBA66D] via-[#D5D1C7] to-gray-200 px-2 py-4 mt-8 flex flex-col items-center '>
                <span className='text-gray-900 font-semibold'>Suggestions for improvement on </span>
                <span className='text-sm tracking-widest'>sudeepbogati080@gmail.com</span>
                <span className='text-base font-medium pt-2 mb-2  border-b border-gray-600 text-gray-800'> Find me on </span>
                <ul className='flex gap-2 w-full items-center justify-around list-disc'> 
                    <li className='hover:underline text-gray-700'><Link href={'https://stackoverflow.com/users/24161634/sudeepbogati'}> StackOverflow </Link></li>
                    <li className='hover:underline text-gray-700'><Link href={'https://github.com/sudeepbogati7'}>Github </Link></li>
                    <li className='hover:underline text-gray-700'><Link href={'https://linkedin.com/in/sudeep-bogati'}> LinkedIn </Link></li>
                    <li className='hover:underline text-gray-700'> <Link href={'https://www.instagram.com/the.sudeep_/'}> Instagram </Link></li>
                </ul>
            </footer>
        </>
    )
