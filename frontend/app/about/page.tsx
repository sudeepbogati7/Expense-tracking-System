...
export default function AboutMe() {
    return (
        <>
            ...
            <footer className=' border-t border-gray-400 bg-gradient-to-t from-[#BBA66D] via-[#D5D1C7] to-gray-200 px-2 py-4 mt-8 flex flex-col items-center dark:bg-gradient-to-t dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 '>
