...
export default function AboutMe() {
    return (
        <>
            <div className="container flex items-center w-5/6 mx-auto py-4 px-2 rounded-2xl shadow-xl dark:shadow-gray-700/30 border border-gray-400 dark:border-gray-700 mt-24 flex-col my-auto ">
                ...
                <div className='pt-2 font-semibold tracking-wide text-3xl border-b-2 border-gray-400 text-orange-600 '>Sudeep Bogati</div>
                <p className='w-4/5 w-full text-base px-2 py-4 tracking-wide'> Hello, This is Sudeep Bogati,a passionate<span className='border-b font-medium border-orange-600'>Software Engineer </span> from Nepal, passionate about using technology to solve problems and create innovative solutions. I'm skilled in applying my engineering knowledge to design, develop, and maintain software applications. With a strong foundation in TypeScript,NEXT.js, NODE.js , I'm eager to contribute to projects that make a positive impact.</p>
                ...
                <div className='flex gap-2 mt-4 items-center'>
                    <span className='text-sm '>Reach me:</span>
