...
export default function AboutMe() {
    return (
        <div className="container flex items-center w-5/6 mx-auto py-4 px-2 rounded-2xl shadow-xl border border-gray-300 flex-col my-auto mt-14">
            ...
            <Link href={'/'} className='border border-gray-300 px-4 py-2 mt-6 rounded-lg bg-gray-300 active:border-2 active:bg-orange-200 active:border-orange-700 transition-all duration-300 '>Home</Link>
        </div>
